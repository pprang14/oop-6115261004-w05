...
namespace oop_6115261004_w05
{
    class Room
    {
        ...
        {
            return this.RoomCode + " " + this.RoomName + " " + this.RoomWidth + " " + this.RoomLength + " " + this.RoomType 
                + this.RoomBuilding.ToString() + " Lat " + this.RoomBuilding.BuildingLat + " Long " + this.RoomBuilding.BuildingLong;
        }
