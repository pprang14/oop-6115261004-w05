...
namespace oop_6115261004_w05
{
    class Subject
    {
        ...
        public Subject() { }
        public Subject(string sc, string sn, string scr, string spe, string spr)
        {
            this.SubjectCode = sc;
            this.SubjectName = sn;
            this.SubjectCredit = scr;
            this.SubjectPeriods = spe;
            this.SubjectPractice = spr;
        }
        public override string ToString()
        {
            return this.SubjectCode + this.SubjectName + this.SubjectCredit + this.SubjectPeriods + this.SubjectPractice;
        }
    }
}